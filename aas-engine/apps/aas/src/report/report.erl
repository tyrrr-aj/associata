...
node_poisoned(NodeId, NewAccPoisonLvl, NewExcitation, Stimulus, Source, Reporter) -> 
    report_timestamped(node_poisoned, {NodeId, NewAccPoisonLvl, NewExcitation, Stimulus, Source}, Reporter).
